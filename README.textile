...
This branch also features zshmarks, a port from bashmarks to zsh
...
(EDIT) Please notice that i've updated this command to use settings from my personal branch. 

@wget --no-check-certificate https://github.com/pellegrino/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
